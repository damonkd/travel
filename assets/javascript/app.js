...
$.get("https://cors-anywhere.herokuapp.com/https://api.travelpayouts.com/v2/prices/latest?currency=usd&period_type=year&page=1&limit=30&show_to_affiliates=true&sorting=price&trip_class=0&token=a63a34e7f0fbe1a88d351460092f8aa3", function(data, status){
    console.log(data);
  });
